...
var _dayViewJs = require("./view/dayView.js");
var _dayViewJsDefault = parcelHelpers.interopDefault(_dayViewJs);
var _allQuotesJs = require("./view/allQuotes.js");
var _allQuotesJsDefault = parcelHelpers.interopDefault(_allQuotesJs);
const fetchTodaysQuote = async function() {
    try {
        (0, _dayViewJsDefault.default).renderSpinner();
        await _module.loadBothQuotes();
        (0, _dayViewJsDefault.default).render(_module.state.quote.quote, _module.state.quote.author);
    } catch (error) {
        (0, _dayViewJsDefault.default).renderError();
    }
};
const fetchQuotesView = async function() {
    try {
        (0, _allQuotesJsDefault.default).renderSpinner();
        await _module.loadBothQuotes();
        (0, _allQuotesJsDefault.default).render(_module.state.quotes);
    } catch (error) {
        (0, _dayViewJsDefault.default).renderError();
    }
};
const init = function() {
    (0, _dayViewJsDefault.default).addHandlerRenderer(fetchTodaysQuote);
    (0, _allQuotesJsDefault.default).addHandlerRenderer(fetchQuotesView);
};
init();

},{"./module":"2UHqf","./view/dayView.js":"kiS3c","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./view/allQuotes.js":"ibnqa","core-js/modules/web.immediate.js":"49tUX","regenerator-runtime/runtime":"dXNgZ"}],"2UHqf":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "state", ()=>state);
parcelHelpers.export(exports, "loadBothQuotes", ()=>loadBothQuotes);
var _webImmediateJs = require("core-js/modules/web.immediate.js");
var _runtime = require("regenerator-runtime/runtime");
...
const loadQuoteOfTheDay = async function() {
    try {
        const data = await (0, _helpers.fetchURL)(`${(0, _configs.API_URL)}${(0, _configs.QUOTE_OF_THE_DAY)}`);
        return data;
    } catch (error) {
        throw error;
    }
...
const allQuotes = async function() {
    try {
        const data = await (0, _helpers.fetchURL)(`${(0, _configs.API_URL)}${(0, _configs.QUOTES)}`);
        return data;
    } catch (error) {
        throw error;
    }
};
const loadBothQuotes = async function() {
    try {
        let [today, quotes] = await Promise.all([
            loadQuoteOfTheDay(),
            allQuotes()
        ]);
...
},{"core-js/modules/web.immediate.js":"49tUX","regenerator-runtime/runtime":"dXNgZ","./configs":"ct778","./helpers":"6s1be","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
"use strict";
...
},{}],"ct778":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "API_URL", ()=>API_URL);
parcelHelpers.export(exports, "QUOTE_OF_THE_DAY", ()=>QUOTE_OF_THE_DAY);
parcelHelpers.export(exports, "QUOTES", ()=>QUOTES);
const API_URL = "https://zenquotes.io/api/";
const QUOTE_OF_THE_DAY = "today";
const QUOTES = "quotes";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kiS3c":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
class QuoteOfTheDay extends (0, _viewDefault.default) {
...
exports.default = new QuoteOfTheDay();

},{"./View":"63su2","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"63su2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class View {
    _data;
    _author;
    _errorMessage = "Something went wrong... reload the page after a few seconds.";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ibnqa":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
class allQuotes extends (0, _viewDefault.default) {
...
exports.default = new allQuotes();

},{"./View":"63su2","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["7uCb0","1GgH0"], "1GgH0", "parcelRequire9222")
